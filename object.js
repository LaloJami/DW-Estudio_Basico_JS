...
var listaAutos = [];
for (let i = 0; i < 3; i++) {
    console.log(`Ingresa datos del auto #${i+1}`);
    let marca = prompt('Marca del carro: ');
    let modelo = prompt('Modelo del carro: ');
    let annio = prompt('Annio del carro: ');

    var addAuto = new auto(marca, modelo, annio);

    listaAutos.push(addAuto);
}
